...
class CabinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cabin" do
    assert_difference("Cabin.count") do
      post cabins_url, params: { cabin: { description: @cabin.description, image: @cabin.image, name: @cabin.name, price: @cabin.price } }
    end
  ...
  test "should update cabin" do
    patch cabin_url(@cabin), params: { cabin: { description: @cabin.description, image: @cabin.image, name: @cabin.name, price: @cabin.price } }
